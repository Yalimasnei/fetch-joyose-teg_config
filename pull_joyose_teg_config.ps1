...
.EXAMPLE
.\pull_joyose_teg_config.ps1 -UseAdb

.EXAMPLE
.\pull_joyose_teg_config.ps1 -Device myron -MiuiRegion CN -Incremental OS3.0.306.0.WPMCNXM

.EXAMPLE
.\pull_joyose_teg_config.ps1 -Server intl -Device duchamp -MiuiRegion US -Locale en_US -NoFetch
#>
